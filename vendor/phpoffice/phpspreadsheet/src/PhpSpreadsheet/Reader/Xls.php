...
//         gestiociated hash of indexed rows and named column fields
...
class Xls extends BaseReader
{
        ...
        for ($i = 0; $i < $countProperties; ++$i) {
            ...
            switch ($id) {
                ...
                case 0x0E:    //    Manager
                    ...
                    break;
                case 0x0F:    //    Customer
                    $this->spreadsheet->getProperties()->setCustomer($value);
    ...
    /**
     *    The NOTE record specifies a comment gestiociated with a particular cell. In Excel 95 (BIFF7) and earlier versions,
...
//                                                    ->setAuthor($author)
    ...
    /**
     * The TEXT Object record contains the text gestiociated with a cell annotation.
     */
