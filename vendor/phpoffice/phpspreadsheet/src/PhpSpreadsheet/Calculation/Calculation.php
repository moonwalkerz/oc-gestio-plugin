...
class Calculation
{
    ...
    //    Array key is the operator, the value indicates whether this is a left or right gestiociative operator
    private static $operatorGestiociativity = [
        '^' => 0, //    Exponentiation
        ...
        while (true) {
            ...
            if ($opCharacter == '-' && !$expectingOperator) {                //    Is it a negation instead of a minus?
                ...
                while ($stack->count() > 0 &&
                    ...
                    @(self::$operatorGestiociativity[$opCharacter] ? self::$operatorPrecedence[$opCharacter] < self::$operatorPrecedence[$o2['value']] : self::$operatorPrecedence[$opCharacter] <= self::$operatorPrecedence[$o2['value']])) {
